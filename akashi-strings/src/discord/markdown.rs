// This code is taken from the repository:
// Repository: https://github.com/Jacherr/assyst2
// Author: @Jacherr
// License: MIT
// Original file: https://github.com/Jacherr/assyst2/blob/master/assyst-string-fmt/src/markdown.rs
